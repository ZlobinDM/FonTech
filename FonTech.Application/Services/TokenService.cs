...
public class TokenService : ITokenService
{
    ...
    public ClaimsPrincipal GetPrincipalFromExpiredToken(string accessToken)
    {
        ...
        var climesPrincipal = tokenHandler.ValidateToken(accessToken, tokenValidationParameters, out var securityToken);
    ...
    public async Task<BaseResult<TokenDto>> RefreshToken(TokenDto dto)
    {
        ...
        var claimPricipal = GetPrincipalFromExpiredToken(accessToken);
        var userName = claimPricipal.Identity?.Name;
        ...
        var newAccessToken = GenerateAccessToken(claimPricipal.Claims);
